...
const QuestionModal = ({ isOpen, onClose, questionId }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="relative w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-background rounded-lg shadow-lg border p-6 animate-in fade-in zoom-in duration-200">
        <button 
          onClick={onClose}
        ...
        {loading ? (
          <div className="flex h-40 items-center justify-center">Loading details...</div>
        ) : details ? (
          <div className="space-y-6">
            <div>
              <h2 className="text-2xl font-bold mr-8 text-primary" dangerouslySetInnerHTML={{__html: details.title}} />
